...
setCppEnvironment()
{
    echo ">>>>>>>>>>>>>>> WARNING: THIS IS A TEMP DAINT ENV <<<"
...
#        module switch cudatoolkit cudatoolkit/8.0.61_2.4.9-6.0.7.0_17.1__g899857c
    fi
    ...
    * )
    ...
    #boost_path=/apps/dom/UES/jenkins/6.0.UP07/gpu/easybuild/software/Boost/1.67.0-CrayGNU-18.08/include
...
setFortranEnvironment()
{
 ...
 #       module switch cudatoolkit cudatoolkit/8.0.61_2.4.9-6.0.7.0_17.1__g899857c
    ...
    cray )
        module load cce
        # Load gcc/6.2.0 to link with the C++ Dynamical Core
        module unload gcc
        module load gcc/6.2.0
    ...
    pgi )
        ...
        export CC=$GCC_PATH/snos/bin/gcc
        export FC=ftn
        export LDFLAGS="-L/opt/gcc/6.2.0/snos/lib64 ${LDFLAGS}"
        ;;
    * )
